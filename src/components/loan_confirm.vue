<template xmlns:font-family="http://www.w3.org/1999/xhtml" xmlns:line-height="http://www.w3.org/1999/xhtml"
  ...
  <div class="hello">
    ...
    <div style="width:1500px;height:300px;margin: auto;border: black solid 1px;text-align: center;width: 20%">
      <el-form style="margin-top: 60px" ref="form" :model="loaninfo" label-width="80px" disabled>
        <el-form-item label="贷款金额:">
          <el-input v-text="loaninfo.loanAmount" style="color: red"></el-input>
        </el-form-item>
        <el-form-item label="还款分期:">
          <el-input v-text="loaninfo.loanStage" style="color: red"></el-input>
        </el-form-item>
        <el-form-item label="每期应还:">
          <el-input v-text="loaninfo.repaymentamount/loaninfo.loanStage" style="color: red"></el-input>
        </el-form-item>
      </el-form>
    </div>
    <el-footer>
...
<script>
  ...
  export default {
    ...
    mounted:function(){
      this.showUser();
      this.loaninfo=this.$route.query.loaninfo
    },
    created(){
